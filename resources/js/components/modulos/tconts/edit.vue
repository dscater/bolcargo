    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>T CONT - <small>Editar</small></h1>
                    </div>
                </div>
            </div>
        </section>
...
export default {
    ...
    methods: {
        // OBTENER EL T CONT
        getTcont() {
            axios.get("/admin/tconts/getTcont/" + this.id).then((response) => {
                this.oTcont = response.data;
                this.getCliente();
                this.listEgresos = this.oTcont.tcont_egresos;
                this.listIngresos = this.oTcont.tcont_ingresos;
            });
        },
        // OBTENER EL CLIENTE
        getCliente() {
            ...
            if (!this.listEgresos[index].id) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        axios
                            .post("/admin/tconts/destroy_ei", formdata)
                            .then((response) => {
                                this.oTcont.total_egresos =
                                    response.data.total_egresos;
                                this.oTcont.total_ingresos =
                                    response.data.total_ingresos;
                                this.oTcont.profit = response.data.profit;
                                this.listEgresos.splice(index, 1);
                                this.calculaTotalEgresos();
                            });
                    }
