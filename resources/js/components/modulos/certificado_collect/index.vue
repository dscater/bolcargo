    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Certificado de Flete Marítimo COLLECT</h1>
                    </div>
                </div>
            </div>
        </section>
                                    ...
                                    <form>
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-12">
                                                ...
                                                >
                                                <el-input v-model="configuracion.operation_manager" readonly></el-input>
                                                <span
                                                    class="error invalid-feedback"
                                                    v-if="errors.tipo"
...
export default {
    ...
    methods: {
        ...
        generaReporte() {
            ...
            axios
                .post("/admin/certificado_collect/pdf", this.oReporte, config)
                .then((res) => {
                    this.errors = [];
                    this.enviando = false;
