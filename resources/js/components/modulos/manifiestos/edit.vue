    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Manifiestos - <small>Editar</small></h1>
                    </div>
                </div>
            </div>
        </section>
                                ...
                                >
                                    <div class="row">
                                        <div class="form-group col-md-4">
                                            ...
                                            >
                                            <el-input
                                                placeholder="Código del Nro. File"
                                                :value="
                                                    oManifiesto.cliente.file_nro
                                                "
                                                readonly
                                            >
                                            </el-input>
    ...
    methods: {
        ...
        formateaManifiesto() {
            ...
            for (let i = 0; i < keys.length; i++) {
                this.oManifiesto[keys[i]] = this.parseEnters(
                    this.oManifiesto[keys[i]]
                );
            }
        },
        // OBTENER EL CLIENTE
        getManifiesto() {
            axios
                .get("/admin/manifiestos/getManifiesto/" + this.id)
                .then((response) => {
                    this.oManifiesto = response.data;
                    this.oCliente = this.oManifiesto.cliente;
                    this.formateaManifiesto();
                });
        },
        ...
        enviaRegistro() {
            this.enviando = true;
            try {
                let url = "/admin/manifiestos/" + this.id;
