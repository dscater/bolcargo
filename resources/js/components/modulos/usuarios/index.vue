    ...
    methods: {
        ...
        editarRegistro(item) {
            ...
            this.oUsuario.nombre = item.nombre
                ? item.nombre
                : "";
            this.oUsuario.paterno = item.paterno
                ? item.paterno
                : "";
            this.oUsuario.materno = item.materno
                ? item.materno
                : "";
            this.oUsuario.ci = item.ci
                ? item.ci
                : "";
            this.oUsuario.ci_exp = item.ci_exp
                ? item.ci_exp
                : "";
            this.oUsuario.dir = item.dir
                ? item.dir
                : "";
            this.oUsuario.correo = item.correo
                ? item.correo
                : "";
            this.oUsuario.fono = item.fono
                ? item.fono
                : "";
            this.oUsuario.cel = item.cel
                ? item.cel
                : "";
