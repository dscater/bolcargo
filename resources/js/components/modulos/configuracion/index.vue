            ...
            <div class="card">
              <div class="card-header">
                <div class="row">
                  <div class="col-md-3">
                    <button
                      v-if="permisos.includes('configuracion.edit')"
                      class="
                ...
                <div class="col-md-12">
                  ...
                  >
                    ...
                    <el-descriptions-item>
                      ...
                      {{ oConfiguracion.operation_manager }}
                    </el-descriptions-item>
                    <el-descriptions-item>
                      <template slot="label">
                        <i class="el-icon-message"></i>
            ...
            <form>
              <div class="row">
                <div class="form-group col-md-6">
                  <label
                    :class="{
                      'text-danger': errors.nombre_sistema,
                    }"
                ...
                <div class="form-group col-md-6">
                  <label :class="{ 'text-danger': errors.alias }">Alias*</label>
                  <input
                    type="text"
                    class="form-control"
                    :class="{
                ...
                <div class="form-group col-md-6">
                  <label :class="{ 'text-danger': errors.fono }"
                    >Teléfono*</label
                  >
                  <input
                    type="text"
                ...
                <div class="form-group col-md-6">
                  <label :class="{ 'text-danger': errors.web }">Web</label>
                  <input
                    type="text"
                    class="form-control"
                ...
                <div class="form-group col-md-6">
                  <label :class="{ 'text-danger': errors.actividad_economica }"
                    >Actividad Económica*</label
                  >
                  <input
                    type="text"
                    class="form-control"
                    :class="{ 'is-invalid': errors.actividad_economica }"
                    placeholder="Actividad Económica"
                    v-model="oConfiguracion.actividad_economica"
                  />
                  <span
                    class="error invalid-feedback"
                ...
                <div class="form-group col-md-6">
                  <label :class="{ 'text-danger': errors.correo }"
                    >Correo</label
                  >
                  <input
                    type="text"
                ...
                <div class="form-group col-md-6">
                  <label :class="{ 'text-danger': errors.operation_manager }"
                    >Operation Manager*</label
                  >
                  <input
                    type="text"
                    class="form-control"
                    :class="{ 'is-invalid': errors.operation_manager }"
                    placeholder="Operation Manager"
                    v-model="oConfiguracion.operation_manager"
                  />
                  <span
                    class="error invalid-feedback"
                    v-if="errors.operation_manager"
                    v-text="errors.operation_manager[0]"
                  ></span>
                </div>
                <div class="form-group col-md-6">
                  <label :class="{ 'text-danger': errors.nombre_cheque }"
                    >Cheque a nombre de*</label
                  >
                  <input
                    type="text"
                    class="form-control"
                    :class="{ 'is-invalid': errors.nombre_cheque }"
                    placeholder="Cheque a nombre de"
                    v-model="oConfiguracion.nombre_cheque"
                  />
                  <span
                    class="error invalid-feedback"
                    v-if="errors.nombre_cheque"
                    v-text="errors.nombre_cheque[0]"
                  ></span>
                </div>
                <div class="form-group col-md-6">
                  <label :class="{ 'text-danger': errors.logo }">Logo</label>
                  <input
                    type="file"
                    class="form-control"
                    :class="{
  ...
  methods: {
    ...
    setRegistroModal() {
      ...
      try {
        ...
        formdata.append("nombre_sistema", this.oConfiguracion.nombre_sistema);
        formdata.append("alias", this.oConfiguracion.alias);
        formdata.append("razon_social", this.oConfiguracion.razon_social);
        ...
        formdata.append(
          "operation_manager",
          this.oConfiguracion.operation_manager
            ? this.oConfiguracion.operation_manager
            : ""
        );
        formdata.append(
          "nombre_cheque",
          this.oConfiguracion.nombre_cheque
            ? this.oConfiguracion.nombre_cheque
            : ""
        );
